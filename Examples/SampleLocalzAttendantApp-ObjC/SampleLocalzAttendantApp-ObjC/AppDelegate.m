...
@interface AppDelegate () <LocalzAttendantSDKDelegate>
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [LocalzAttendantSDK initWithAppId:self.spotzAppId appKey:self.spotzAppKey cncKey:self.spotzCNCKey delegate:self options:nil];
...
#pragma mark - LocalzAttendantSDKDelegate

- (void)localzAttendantSDKInit:(NSError *)error {
    
    if (error) {
        NSLog(@"LocalzAttendantSDK init failed with error %@", error);
    } else {
        NSLog(@"LocalzAttendantSDK init successful");
    }
}
